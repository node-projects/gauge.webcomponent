...
export class DoubleGaugeComponent extends BaseCustomWebComponentConstructorAppend {
    ...
    static override readonly template = html`
        <div id="root" style="width: 100%; height: 100%">
            <svg viewBox="0 0 120 120" style="width: 100%; height: 100%"><g transform= "translate(10,10)">
    ...
    ready() {
        ...
        this.setValues(10, 90);
        this.animateRandom(250);
    }



    setValues(first: number, second: number) {
        if (first !== null) {
            this.value1 = first;
        ...
        this._aggregated.innerHTML = "OEE " + Math.round(this.value1 * this.value2 / 100) + " %";
    }
    ...
    animateRandom(delay) {
        ...
        if (this.value1 > 100 || this.value1 < 0)
            this.value1 = 50;
        this.setValues(this.value1, null);
        ...
        if (this.value2 > 100 || this.value2 < 0)
            this.value2 = 50;
        this.setValues(null, this.value2);
